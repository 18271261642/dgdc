package com.jkcq.viewlibrary.pickerview.utils;
...
// }
    ...
    public static ArrayList<String> getLongTimeStr(long time) {
        ...
        strs.add(DateUtil.formatTwoStr(calendar.get(Calendar.MONTH) + 1) + "/" + DateUtil.formatTwoStr
                (calendar.get(Calendar.DAY_OF_MONTH)));
        strs.add(DateUtil.formatTwoStr(calendar.get(Calendar.HOUR_OF_DAY)) + ":" + DateUtil.formatTwoStr
