package com.jkcq.viewlibrary.pickerview.view;
...
import com.jkcq.viewlibrary.pickerview.adapter.WheelAdapter;
import com.jkcq.viewlibrary.pickerview.listener.OnItemSelectedListener;
import com.jkcq.viewlibrary.pickerview.model.IPickerViewData;
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    try {
                        preSelectedItem = adapter.indexOf(visibles[counter]);
                    } catch (Exception e) {
                        preSelectedItem = -1;
                    } finally {
