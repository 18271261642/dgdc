...
//    }
    ...
    private void init() {
        ...
        mOSS = new OSSClient(BaseApp.Companion.getSApplicaton(), ALIYUN_URL, credentialProvider, conf);
        OSSLog.enableLog();
    }
    ...
    public void downFile(String filePath, String url) {
        ...
        task = mOSS.asyncGetObject(get, new OSSCompletedCallback<GetObjectRequest, GetObjectResult>() {
            @Override
