...
//        }
        ...
        if (monthDataListen != null) {
            String strMonth = mRightNow.get(Calendar.YEAR) + "-" + formatTwoStr(mRightNow.get(Calendar.MONTH) + 1);
    ...
    public void goCurrentMonth() {
        ...
        requestLayout();
        if (monthDataListen != null) {
            String strMonth = mHelper.getYear() + "-" + formatTwoStr(mHelper.getMonth() + 1);
            monthDataListen.getMontData(strMonth);
        }
