package com.jkcq.base.easybarrage;
...
public class BarrageView extends RelativeLayout {
    ...
    private final int DEFAULT_PADDING = DateUtil.dip2px(15);
    ...
    private void showBarrage(final Barrage tb) {
        ...
        // Drawable drawable = textView.getContext().getResources().getDrawable(R.drawable.shape_btn_green_grey_radio_15_bg);
        // textView.setBackgroundDrawable(tintDrawable(drawable, tb.getBackGroundColor()));
        textView.setBackgroundResource(R.drawable.shape_btn_green_grey_radio_15_bg);
    ...
    private int getRandomTopMargin() {
        ...
        while (true) {
            ...
            if (!existMarginValues.contains(marginValue)) {
                ...
                Log.e("marginValue", "marginValue=" + marginValue + "DateUtil.getScreenHeight(mContext)" + DateUtil.getScreenHeight(mContext) * 0.72);
                if (marginValue + DateUtil.dip2px(75) > DateUtil.getScreenHeight(mContext) * 0.5) {
                    marginValue = marginValue - DateUtil.dip2px(75);
                }
                Log.e("marginValue", "marginValue=" + marginValue);
                return marginValue;
            }
        }
    }
