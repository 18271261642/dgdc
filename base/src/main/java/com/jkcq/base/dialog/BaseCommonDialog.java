 ...
 * 功能：dialog基类
 */
public class BaseCommonDialog extends AppCompatDialog implements DialogInterface {
    private DialogController mController;

    public BaseCommonDialog(@NonNull Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public BaseCommonDialog create() {
            final BaseCommonDialog dialog = new BaseCommonDialog(P.mContext, P.mThemeResId);
        ...
        public BaseCommonDialog show() {
            final BaseCommonDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
