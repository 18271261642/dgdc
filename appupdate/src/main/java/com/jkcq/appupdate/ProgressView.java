...
public class ProgressView extends View {
    ...
    private void initPaint() {
        ...
        circlepaint.setColor(mContext.getResources().getColor(R.color.view_bg_color));
        circlepaint.setStyle(Paint.Style.STROKE);
        circlepaint.setStrokeCap(Paint.Cap.ROUND);

        //paint.setStrokeWidth(DisplayUtils.dip2px(mContext, 10));
        paint.setColor(mContext.getResources().getColor(R.color.view_bg_color));
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(arcRectF, (arcRectF.bottom - arcRectF.top) / 2, (arcRectF.bottom - arcRectF.top) / 2, paint);


        arcRectF.set(0, centerY - radius, (getWidth() * progress / 100.0f), centerY + radius);

        if (arcRectF.right - arcRectF.left < (arcRectF.bottom - arcRectF.top)) {
            arcRectF.set(0, centerY - radius, (arcRectF.bottom - arcRectF.top) , centerY + radius);
        }
        ...
        canvas.drawRoundRect(arcRectF, (arcRectF.bottom - arcRectF.top) / 2, (arcRectF.bottom - arcRectF.top) / 2, arcCirclepaint);
